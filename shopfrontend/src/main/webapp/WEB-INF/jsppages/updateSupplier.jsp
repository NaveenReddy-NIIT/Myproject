...
<tr>
<td>Supplier Name</td>
<td><input type="text"id="supname" name="supname" value="${supplier.supplierName}"/></td>
</tr>
<tr>
<td>Supplier Location</td>
<td><input type="text" id="supploc" name="supploc" value="${supplier.supplierLocation}"/></td>
</tr>
<tr>
<td colspan = "2">
