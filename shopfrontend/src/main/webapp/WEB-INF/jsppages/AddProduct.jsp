...
<tr>
<td colspan = "2">
<center><input type="submit" class="btn btn-success btn-xs" value="AddProduct"/>
...
<td><img src="<c:url value="/resources/images/${product.productId}.jpg"/>" alt="image" width="50px" height="55px"></td>
