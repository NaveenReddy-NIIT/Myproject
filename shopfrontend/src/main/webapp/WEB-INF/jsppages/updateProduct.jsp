...
<td><input type="text" name="prodescription" value="${product.productDescription}"/></td>
</tr>
<tr>
<td>Product Price</td>
<td><input type="text" name="proprice" value="${product.price}"/></td>
</tr>
<tr>
<td>Product Stock</td>
<td><input type="text" name="prostock" value="${product.stock}"/></td>
</tr>
<tr>
<td>Product Image</td>
...
<td><img src="<c:url value="/resources/images/${product.productId}.jpg"/>"  width="50px" height="55px"></td>
